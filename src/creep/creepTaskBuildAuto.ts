...
export class CreepTaskBuildAuto extends CreepTask{
    constructor(manager: CreepManager, args: CreepTaskArgsBuildAuto, repeating: boolean = false, priority: boolean = false, promiseId?: string, name: string = CreepTaskBuildAuto.name){
